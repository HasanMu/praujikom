...
<head>
    ...
    <!-- Font Awesome -->
    <link rel="stylesheet" href="{{ asset('assets/fe/AdminLTE/bower_components/font-awesome/css/font-awesome.min.css') }}">
    <!-- Ionicons -->
    ...
    <link rel="stylesheet" href="{{ asset('css/custom-fe-users.css') }}">
...
<body class="hold-transition skin-purple-light sidebar-mini">
    <div class="wrapper">
        ...
        @include('frontend.users/template/navbar')
        <!-- Left side column. contains the logo and sidebar -->
        @include('frontend.users/template/side')
    ...
    <!-- jQuery 3 -->
    <script src="{{ asset('assets/fe/AdminLTE/bower_components/jquery/dist/jquery.min.js')}}"></script>
    <!-- Bootstrap 3.3.7 -->
    ...
    <script src="{{ asset('assets/fe/AdminLTE/dist/js/demo.js')}}"></script>
</body>
