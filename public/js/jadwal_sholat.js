...
$("#cari-jadwal-sholat").on("click", function() {
    // keterangan-jadwal-sholat
    var kota_$ = $('#search_kabko').val();
    var waktu_$ = $("#waktu-jadwal-sholat").val();

    if (kota_$ == "" || waktu_$ == "" || kota_$ == "" && waktu_$ == "") {
        ...
        iziToast.show({
            ...
            title: "Ups!",
            message: "Kolom Kabupaten/Kota atau Waktu tidak boleh kosong!",
            target: "#keterangan-jadwal-sholat"
        });
    }
    ...
    if(kota_$ != "" && waktu_$ != "") {
        ...
        if (ifConnected) {
            ...
            iziToast.warning({
                ...
                transitionOutMobile: "fadeOut",
                title: "Ups!",
                message: "Periksa kembali koneksi internetmu!",
                target: "#keterangan-jadwal-sholat"
            });
        }
    }
